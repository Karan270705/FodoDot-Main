    ...
    <div className="recipe w-80 overflow-hidden bg-white/75 rounded-2xl p-5 shadow-xl shadow-red-100 border-2 border-white flex flex-col gap-5">
      ...
      <div className="texts">
        ...
        <Link
          ...
          className="bg-gradient-to-br from-red-100 to-purple-500 text-rose-50 p-3 px-5 rounded-lg text-sm uppercase font-semibold tracking-wider mt-2 inline-block shadow-md shadow-red-200 hover:shadow-lg hover:shadow-red-300 duration-300"
        >
          view recipe
        </Link>
      </div>
